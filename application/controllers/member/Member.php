...
class Member extends CI_Controller 
{
    ...
    public function index()
    {
        ...
        $where = array('berita.id_kategori' => 12);
        $news_limit = 4;
        $data["announce_news"] = $this->News_model->get_announce_news($where, $news_limit);
    ...
    public function news()
    {
        ...
        $config = array();
		$config["base_url"] = base_url() . "member/member/news/";
    ...
    public function news_increment($idnews)
    {
        ...
        redirect('member/Member/news_preview/'. $idnews);
    }
    ...
    public function new_comment($idnews)
    {
        ...
        return redirect('member/Member/news_preview/'.$idnews);
        }
    }
}